 ...
 */
public class ActiviteitenLoader extends AsyncTaskLoader<Cursor> {
    ...
    public ActiviteitenLoader(Context context){
        super(context);
    }
    ...
    private void loadCursor(){
        synchronized (lock){
            ...
            int id = 1;
            for (Place place : PlaceAdmin.getInstance().getActiviteiten()){
