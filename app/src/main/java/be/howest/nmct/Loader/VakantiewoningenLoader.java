 ...
 */
public class VakantiewoningenLoader extends AsyncTaskLoader<Cursor> {
    ...
    public VakantiewoningenLoader(Context context){
        super(context);
    }
    ...
    private void loadCursor(){
        synchronized (lock){
            ...
            int id = 1;
            for (Place place : PlaceAdmin.getInstance().getVakantieWoningen()){
